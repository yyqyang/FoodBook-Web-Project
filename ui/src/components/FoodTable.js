                        ...
                        recipes && recipes.map((recipes) => {
                            ...
                            return (
                                ...
                                <Grid container
                                    ...
                                    <Grid item
                                        xs={4}>
                                        <TextField name="Food" label="Food" variant="outlined" margin="dense" color="secondary"
                                    ...
                                    <Grid item
                                        xs={4}>
                                        <TextField name="Kcal" label="Kcal" variant="outlined" margin="dense" color="secondary"
                                    ...
                                    <Grid item
                                        xs={4}>
                                        <TextField name="Quantity" label="Quantity" variant="outlined" margin="dense" color="secondary"
                                            onChange={
                                                props.handleChange
                                            }
                                            onBlur={
